...
import it.gov.pagopa.paymentupdater.consumer.utils.types.ArrayConverter;
import it.gov.pagopa.paymentupdater.consumer.utils.types.AvroTypeConverter;
import it.gov.pagopa.paymentupdater.consumer.utils.types.BytesDecimalConverter;
import it.gov.pagopa.paymentupdater.consumer.utils.types.EnumConverter;
import it.gov.pagopa.paymentupdater.consumer.utils.types.LongTimestampMillisConverter;
import it.gov.pagopa.paymentupdater.consumer.utils.types.MapConverter;
import it.gov.pagopa.paymentupdater.consumer.utils.types.NullConverter;
import it.gov.pagopa.paymentupdater.consumer.utils.types.PrimitiveConverter;
import it.gov.pagopa.paymentupdater.consumer.utils.types.RecordConverter;
import it.gov.pagopa.paymentupdater.consumer.utils.types.UnionConverter;
